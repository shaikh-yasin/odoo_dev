...
class HospitalPatient(models.Model):
    ...
    def print_report(self):
        return self.env.ref('hospital_patient.report_patient_card').report_action(self)

    def print_report_excel(self):
        return self.env.ref('hospital_patient.report_patient_card_xlx').report_action(self)
...
#            'target':'new'
    ...
    def action_send_card(self):
        ...
        print('Hellooooooooooooooooooooooooooo',template)
